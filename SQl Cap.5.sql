...
--Inserindo linha na tabela aluno
INSERT INTO TALUNO VALUES (10, 'PEDRO', 'NOVO HAMBURGO','96853214','RS', NULL,'25/06/1982');

SELECT * FROM TALUNO

CREATE TABLE TDESCONTO--Criando tabela tdesconto
( CLASSE VARCHAR(1) PRIMARY KEY,
  INFERIOR NUMBER(4,2),
  SUPERIOR NUMBER(4,2)
);
--inserindo Linhas tabela tdesconto
...
UPDATE TCONTRATO SET--Atualizando linha codigo contrato 6
       DESCONTO = 27
WHERE  COD_CONTRATO = 6;

UPDATE TCONTRATO SET --Atualizando linha codigo contrato 5
       DESCONTO = 18
...
SELECT * FROM TCURSO
--Inserindo linhas na tabela tcurso
INSERT INTO TCURSO VALUES (6, 'PHP', 1000, 100,2);
INSERT INTO TCURSO VALUES (7,'LOGICA',100,20,4);

SELECT * FROM TCURSO

UPDATE TCURSO SET PRE_REQ = 7--Atualizando coluna pre_req cod curso1
WHERE COD_CURSO = 1;

UPDATE TCURSO SET PRE_REQ = 7--Atualizando coluna pre_req cod curso3
WHERE COD_CURSO = 3;

UPDATE TCURSO SET PRE_REQ = 1--Atualizando coluna pre_req cod curso2
WHERE COD_CURSO = 2;

UPDATE TCURSO SET PRE_REQ = 3--Atualizando coluna pre_req cod curso4
WHERE COD_CURSO = 4;

UPDATE TCURSO SET PRE_REQ = 7--Atualizando coluna pre_req cod curso6
WHERE COD_CURSO = 6;
...
--Retorna o nome do curso e o nome do pré requisito
